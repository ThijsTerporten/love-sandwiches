...
def get_sales_data():
    ...
    The loop will request data untill it is valid.
    """
    while True:
...
def validate_data(values):
    """
    Inside this function, converts all string values into integers.
...
#     """
#     Update surplus worksheet, add new row by using data from surplus data.
#     """
...
def get_last_5_entries_sales():
    ...
    the last 5 entries for eachj sandwich and returns the data
    as a list of lists.
    """
